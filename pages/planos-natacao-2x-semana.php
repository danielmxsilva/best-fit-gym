...
Após envio aguarde nosso contato para finalização e aprovação de sua matricula..</p>
    ...
    <div class="wrap-form form-planos">
        <form method="POST">
            <input type="hidden" name="identificador" value="Natação 2X/Semana" />
            <select name="plano">
                <option value="anual 12X 190,00R$">Plano Anual 12X R$190,00 </option>
                <option value="semestral 6X 219,00R$">Plano Semestral 6X R$219,00</option>
                <option value="mensal 1X 250,00R$">Plano Mensal 1X 250,00</option>
            </select>
