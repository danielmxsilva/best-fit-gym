...
Após envio aguarde nosso contato para finalização e aprovação de sua matricula..</p>
    ...
    <div class="wrap-form form-planos">
        <form method="POST">
            <input type="hidden" name="identificador" value="Musculação + aula Best Nova Monte Serrat" />
            <select name="plano">
                <option value="anual 12X 79,99R$">Plano Anual 12X R$79,99 </option>
                <option value="semestral 6X 99,99R$">Plano Semestral 6X R$99,99</option>
                <option value="mensal 1X 109,99R$">Plano Mensal 1X 109,99</option>
            </select>
